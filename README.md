...
スキルファイルは `.claude/skills/dns-register/SKILL.md` に配置されており、Cowork がワークスペースを開いた際に自動で読み込みます。手動でのアップロードや登録は不要です。
...
スキルファイルは `.claude/skills/dns-register/SKILL.md` に配置されており、Cowork がワークスペースを開いた際に自動で読み込みます。
